...
[vbwagner #7](https://github.com/vbwagner/catdoc/issues/7) | vbwagner-issue-7.test | vbwagner_issue_7/2 | xls2csv | ✅ PASS | (this commit) | AccessViolation at xlsparse.c:679 (number2string) |
...
[vbwagner #10](https://github.com/vbwagner/catdoc/issues/10) | vbwagner-issue-10.test | vbwagner_issue_10/5 | xls2csv | ❌ XFAIL | No | AccessViolation at xlsparse.c:438 |
